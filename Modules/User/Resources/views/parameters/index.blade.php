          ...
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              ...
              @can('parameter-create')
                <a href="/user/parameters/create" class="main-btn info-btn btn-hover btn-sm"><i class="lni lni-plus mr-5"></i> Nuevo</a>
              @endcan  
            </div>
          </div>
          <!-- end col -->
            ...
            <div class="col-lg-12">
              ...
              <div class="right">
                ...
                <div class="table-wrapper table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="min-width"><p>{{ $parameter->phone }}</p></td>
                            <td class="min-width"><p>{{ $parameter->email }}</p></td>
                            <td class="min-width"><p>{{ $parameter->address }}</p></td>
                            <td class="text-right">
                                <div class="btn-group">
                                    <div class="action">
                  ...
                  <!-- end table -->
                  @if (isset($search))
                      {!! $parameters-> appends($search)->links() !!} <!-- appends envia variable en la paginacion-->
                  @else
                      {!! $parameters-> links() !!}    
                  @endif
                </div>
